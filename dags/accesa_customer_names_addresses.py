...
with DAG(
    dag_id = "accesa_customer_names_addresses",
    catchup = False,
    ...
    spark_job = SparkSubmitOperator(
        task_id = 'run_accesa_customer_names_addresses',
        application = 'scripts/spark_jobs/accesa_customer_names_addresses.py',
        conn_id = 'spark_default',
        application_args = [
            "--project", GCP_PROJECT_ID,
            "--dataset", "bank_raw_daily_ingest_analytics",
            "--table", "accesa_customer_names_addresses",
            "--temp-bucket", BUCKET,
        ],
        conf = {
    ...
    mail = EmailOperator(
        ...
        subject = 'Accesa Customer Names & Addresses done',
        html_content = '<p>Name + street analytics done.</p>'
    )
